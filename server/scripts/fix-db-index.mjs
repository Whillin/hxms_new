...
async function fixDb(conn, db) {
  ...
  const hasIdxCustomerStore = idxList.some((i) => i.name === 'idx_customer_store' && i.cols.length === 1 && i.cols[0] === 'storeId');
  ...
  const dupCntBefore = Array.isArray(dupBefore) && dupBefore.length ? Number(dupBefore[0]?.cnt || 0) : 0;
  if (dupCntBefore > 0) {
